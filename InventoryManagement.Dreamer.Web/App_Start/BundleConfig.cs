...
namespace InventoryManagement.Dreamer.Web.App_Start
{
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new ScriptBundle("~/Scripts/SiteScript").Include(
            ...
            bundles.Add(new StyleBundle("~/Content/kendo").Include(
                ...
                "~/Content/Kendo/kendo.metro.*"));
            bundles.Add(new StyleBundle("~/Content/Dashboard").Include(
                "~/Content/Dashbord.css"));
            ...
            bundles.Add(new StyleBundle("~/Content/themes/css").Include(
                        "~/Content/themes/base/south-street/jquery-ui-1.10.3.custom.min.css"));
        }
    }
}